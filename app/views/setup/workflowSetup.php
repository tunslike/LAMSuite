...
<h5 class="fw-bold my-2 descTxthdr" style="color:#f8285c;">Update Workflow Approvals</h5>
    <br>
    <div class="mb-10">
    ...
    <div class="mb-10">
        ...
        <select class="form-select" name="apprv1" data-control="select2" data-placeholder="Select staff name here">
                <option></option>
    ...
    <div class="mb-10">
        ...
        <select class="form-select" name="apprv2" data-control="select2" data-placeholder="Select staff name here">
                <option></option>
				<?php foreach($data['users'] as $user): ?>
						<option value="<?php echo $user->ENTRY_ID ?>"><?php echo $user->FIRST_NAME.' '.$user->LAST_NAME; ?></option>
				<?php endforeach; ?>

   ...
   <div class="card-header border-0 pt-6">
	  ...
	  <div class="d-flex justify-content-end" data-kt-subscription-table-toolbar="base">
        ...
        <!--begin::Add subscription-->
            <a href="#"  data-bs-toggle="modal" data-bs-target="#create_new_user" class="btn btn-success">
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_subscriptions_table">
               <thead>
                  <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
				    ...
				    <th style="width: 80px;">Status</th>
					 ...
					 <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_subscriptions_table" rowspan="1" colspan="1" aria-label="Status: activate to sort column ascending" style="width: 188.375px;">Username</th>
                     ...
                     <th class="min-w-70px sorting_disabled" rowspan="1" colspan="1" aria-label="Actions" style="width: 144.922px;">Action</th>
                  </tr>
               </thead>
               ...
               <?php foreach($data['users'] as $user): ?>
                ...
                <tr class="odd">
                     ...
                     <td>
                            <span class="badge badge-light"><?php echo $user->MOBILE_PHONE; ?></span>              
                     </td>
					 <td>
					 ...
					 <td>
					 <span class="badge badge-light-primary"><?php echo $user->USERNAME; ?></span>                
                     </td>
					 ...
					 <?php 
                            switch($user->ROLE_ID) {
                                case '001':
                                    echo '<div class="badge badge-light-primary">Administrator</div>';
                                break;
                                case '002':
                                    echo '<div class="badge badge-light-primary">Supervisor</div>';
                                break;
								case '003':
                                    echo '<div class="badge badge-light-primary">Loan Officer</div>';
                                break;
								case '004':
                                    echo '<div class="badge badge-light-primary">CRM Officer</div>';
                                break;
								case '005':
					 ...
					 <td>
                        <span class="badge badge-light"><?php echo formatDateCreated($user->DATE_CREATED); ?></span>  
                     </td>
					 <td>
                        <span class="badge badge-light"><?php echo formatDateCreated($user->FIRST_LOGIN_DATE); ?></span>  
                     </td>
					 <td>
                     ...
                     <td class="text-end">
                        <a href="#" onclick="showManageUserProfile('<?php echo $user->ENTRY_ID; ?>');" class="btn btn-primary btn-active-light-primary btn-sm">
                        Manage</a>
                     </td>
                  </tr>

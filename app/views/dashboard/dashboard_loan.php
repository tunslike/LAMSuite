						...
						<div class="toolbar d-flex align-items-stretch">
							...
							<div class="container-xxl py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
								...
								<div class="page-title d-flex justify-content-center flex-column me-5">
									<!--begin::Title-->
									<h1 class="d-flex flex-column text-gray-900 fw-bold fs-3 mb-0">Loan</h1>
									<!--end::Title-->
									<!--begin::Breadcrumb-->
...
?>
 ...
 <span class="path6"></span>
												...
												<div class="text-white fw-bold fs-2 mb-2 mt-5" ><?php echo $data['loan']->ACTIVE_LOANS; ?></div>
									...
									<div class="col-xl-4">
										...
										<a href="#" class="card bg-primary hoverable card-xl-stretch mb-xl-8">
											...
											<div class="card-body">
												...
												<div class="text-white fw-bold fs-2 mb-2 mt-5">₦<?php echo number_format($data['loan']->AMOUNT_DISBURSED,2); ?></div>
									...
									<div class="col-xl-4">
										...
										<a href="#" class="card bg-danger hoverable card-xl-stretch mb-5 mb-xl-8">
											...
											<div class="card-body">
												...
												<div class="text-white fw-bold fs-2 mb-2 mt-5">₦<?php echo number_format($data['loan']->TOTAL_REPAYMENT,2); ?></div>

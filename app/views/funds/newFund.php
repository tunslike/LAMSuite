...
?>
				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<h3 class="fw-bold my-2 welcomeTxt">Create New Fund</h3>
...
<br><br>
   ...
   <?php if(!empty($data['fieldError']) && $data['fieldError'] != '') : ?>
    ...
    <div class="mb-10">
        <label for="exampleFormControlInput1" class="required form-label">Fund Name</label>
        <input type="text" name="fundname" class="form-control" placeholder="Enter fund name"/>
    </div>

    <div class="mb-10">
        <label for="exampleFormControlInput1" class="required form-label">Fund Type</label>
    ...
    <div class="mb-10">
        <label for="exampleFormControlInput1" class="form-label">Fund Budget</label>
        <input type="number" name="fundBudget" class="form-control" placeholder="Enter total budget amount" value="0"/>
    </div>

    <div class="mb-10">
        <label for="exampleFormControlInput1" class="form-label">Maximum Fund Subscribers</label>

...
?>
				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
							...
							<div class="container-xxl py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
								...
								<div class="page-title d-flex justify-content-center flex-column me-5">
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-gray-900">Disburse Loan</li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
								</div>
					...
					<h3 class="fw-bold my-2 welcomeTxt">Loan Disbursement</h3>
...
<div class="alert alert-dismissible bg-light-danger d-flex flex-column flex-sm-row p-5 mb-10">
   ...
   <div class="d-flex flex-column pe-0 pe-sm-10">
	   <!--begin::Title-->
	   <h6 style="padding-top:8px;">Please verify customer and loan details before you authorize loan disbursement</h6>
	   <!--end::Title-->
   </div>
   <!--end::Wrapper-->
</div>
<!--end::Alert-->
  ...
  <div class="mb-10">
   ...
   <button type="button" class="btn btn-primary" id="btnSearchCustomerProfileDisbursement">
...
<br>
   ...
   <span class="badge badge-light-primary">Customer Details</span>
   </div>
   ...
   <div style="margin-bottom:20px;">
   <span class="badge badge-light-primary">Loan Details</span>
   </div>

   <div class="row mb-10">
	<div class="col-md-6 fv-row fv-plugins-icon-container">
	   <label for="exampleFormControlInput1" style="color:red;" class="form-label">Loan Amount</label>
	   <input type="text" name="employerArea" style="color:red;font-weight:bold;" id="cust_loan_amount" readonly class="form-control"/>
	</div>
	<div class="col-md-6 fv-row fv-plugins-icon-container">
	   <label for="exampleFormControlInput1" style="color:red;" class="form-label">Loan Tenor</label>
	   <input type="text" name="employerState" style="color:red;font-weight:bold;" id="cust_loan_tenor" readonly class="form-control"/>
	</div>
   </div>
   ...
   <div style="margin-bottom:20px;">
   <span class="badge badge-light-primary">Disbursement Details</span>
   </div>
  ...
  <br>
   <div style="margin-bottom:20px;">
   <span class="badge badge-light-primary">Administration & Approvals</span>
   </div>
   <div class="row mb-10">
	<div class="col-md-6 fv-row fv-plugins-icon-container">
	   <label for="exampleFormControlInput1" class="form-label">Approval Policy</label>
	   <input type="text" name="phonenumber" readonly id="approvalPolicy" class="form-control"/>
	</div>
   </div>
   <div class="row mb-10">
	<div class="col-md-6 fv-row fv-plugins-icon-container">
   ...
   <div class="row mb-10">
	<div class="col-md-6 fv-row fv-plugins-icon-container">
	   <label for="exampleFormControlInput1" class="form-label">Approval One Date</label>
	   <input type="text" name="phonenumber" readonly id="approval1Date" class="form-control"/>
	</div>
	<div class="col-md-6 fv-row fv-plugins-icon-container">
	   <label for="exampleFormControlInput1" class="form-label">Approval One By</label>
	   <input type="text" name="emailaddress" readonly id="approval1By" class="form-control"/>
	</div>
   </div>

   <div class="row mb-10">
	<div class="col-md-6 fv-row fv-plugins-icon-container">
	   <label for="exampleFormControlInput1" class="form-label">Approval Two Date</label>
	   <input type="text" name="phonenumber" readonly id="approval2Date" class="form-control"/>
	</div>
	<div class="col-md-6 fv-row fv-plugins-icon-container">
	   <label for="exampleFormControlInput1" class="form-label">Approval Two By</label>
	   <input type="text" name="emailaddress" readonly id="approval2By" class="form-control"/>
	</div>
   </div>
...
<button type="button" class="btn btn-primary" id="btnAuthoriseLoanDisburse">
	   
<!--begin::Indicator label-->
<span class="indicator-label">
   Authorize Disbursement</span>
<!--end::Indicator label-->
...
<!-- ****************************** Create New Fund Form ends here *********************************** -->
		...
		<!--begin::Modals-->
		<div class="modal fade" id="authorize_loan_amount" tabindex="-1" style="display: none;" aria-hidden="true">
    <!--begin::Modal dialog-->
    <div class="modal-dialog modal-dialog-centered mw-650px">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header" id="kt_modal_create_api_key_header">
                <!--begin::Modal title-->
                <h2>Confirm Disbursement Amount</h2>
                <!--end::Modal title-->
            ...
            <form id="kt_modal_create_api_key_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" action="#">
                ...
                <div class="modal-body py-10 px-lg-17">
					...
					<input type="hidden" id="loadIDNumber" value="">
                    ...
                    <!--begin::Input group-->
                        <div class="row mb-5">
                            ...
                            <div class="col-md-6 fv-row">
                                <!--begin::Label-->
                                <label style="color:red;" class="fs-5 fw-semibold mb-2">Approved Amount</label>
                                <!--end::Label-->

                                <!--begin::Input-->
                                <input type="text" style="color:red;" class="form-control" readonly id="disburs_approve_amount"/>
                                <!--end::Input-->
                            </div>
                            <!--end::Col-->
                            ...
                            <div class="col-md-6 fv-row">
                                <!--end::Label-->
                                <label style="color:blue;" class="fs-5 fw-semibold mb-2">Disbursed Amount</label>
                                <!--end::Label-->

                                <!--end::Input-->
                                <input type="text" style="color:blue;" onblur="validateDisburseAmount();"  id="disburs_amount" class="form-control"/>
                                <!--end::Input-->
                            </div>
                            <!--end::Col-->
                        </div>
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-md-6 fv-row">
                                <!--begin::Label-->
                                <label class="fs-5 fw-semibold mb-2">Bank Name</label>
                                <!--end::Label-->

                                <!--begin::Input-->
                                <input type="text" class="form-control" readonly id="disburs_bankname"/>
                                <!--end::Input-->
                            </div>
                            <!--end::Col-->
                            ...
                            <div class="col-md-6 fv-row">
                                <!--end::Label-->
                                <label class="fs-5 fw-semibold mb-2">Account Number</label>
                                <!--end::Label-->

                                <!--end::Input-->
                                <input type="text" id="disburs_accountName" readonly class="form-control"/>
                                <!--end::Input-->
                            </div>
                            <!--end::Col-->
                        </div>
						...
						<div class="mb-10">
        <label for="exampleFormControlInput1" class="required form-label">Payment Method</label>
            <select id="paymentMethod" class="form-select" aria-label="Select example">
            	<option selected="selected" value="">Select here</option>
				<option value="Bank Transfer">Bank Transfer</option>
				<option value="Bank Transfer">Payment Gateway</option>
						...
						<div class="mb-10">
	   <label for="exampleFormControlInput1" style="color:#1d76cf;" class="form-label">Authorization Comment</label>
	   <textarea id="disburse_authorize_comment" class="form-control mb-8" rows="3"></textarea>
   </div>
                ...
                <div class="modal-footer flex-center">
                    ...
                    <!--begin::Button-->
                    <button type="button" id="btnAuthorizeLoanPayment" class="btn btn-success">
                        <span class="indicator-label">
                            Authorize Payment
                        </span>
                        <span class="indicator-progress">

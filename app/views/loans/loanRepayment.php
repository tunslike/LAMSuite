...
?>
				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
							...
							<div class="container-xxl py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
								...
								<div class="page-title d-flex justify-content-center flex-column me-5">
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-gray-900">Loan Repayment</li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
								</div>
					...
					<h3 class="fw-bold my-2 welcomeTxt">Loan Repayment</h3>
...
<br>
   ...
   <div class="row mb-10">
	...
	<div class="col-md-6 fv-row fv-plugins-icon-container">
	   ...
	   <select name="repay_type" class="form-select" id="repay_type">
				...
				<option value="Monthly Repayment">Monthly Repayment</option>
   ...
   <div class="row mb-10">
	<div class="col-md-6 fv-row fv-plugins-icon-container">
	   <label for="exampleFormControlInput1" class="form-label">Payment Channel</label>
	   <select name="repay_type" class="form-select" id="repay_channel">
				<option value="">Select here</option>
				<option value="Bank Transfer">Bank Transfer</option>
				<option value="Online Card Payment">Online Card Payment</option>
				<option value="USSD shortcode Payment">USSD shortcode Payment</option>
	   </select>
	</div>
	<div class="col-md-6 fv-row fv-plugins-icon-container">
   ...
   <div class="mb-10">
        <label for="exampleFormControlInput1" class="form-label">Payment Narration</label>
        <textarea id="repay_narration" class="form-control" rows="3"></textarea>
    </div>

  <br>
<p>

<button type="button" class="btn btn-primary" id="btnPostCustomerRepayment">

...
?>
				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
							...
							<div class="container-xxl py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
								...
								<div class="page-title d-flex justify-content-center flex-column me-5">
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-gray-900">New Account</li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
								</div>
					...
					<h3 class="fw-bold my-2 welcomeTxt">Create New Account</h3>
...
<!-- ****************************** Create New Fund Form starts here ********************************* -->
   ...
   <form action="<?php echo URLROOT ?>/funds/newFund" id="kt_careers_form" method="post" class="form mb-15 fv-plugins-bootstrap5 fv-plugins-framework">
...
<div class="alert alert-success d-flex align-items-center p-5">
    ...
    <div class="d-flex flex-column">
        ...
        <!--begin::Content-->
        <span>Fund has been created successfully and submitted for review.</span>
        <!--end::Content-->
    </div>
    <!--end::Wrapper-->
</div>
   ...
   <?php if(!empty($data['fieldError']) && $data['fieldError'] != '') : ?>
    ...
    <div class="mb-10">
        ...
        <select name="fundtype" class="form-select" aria-label="Select example">
            ...
            <option value="M">Investment Account</option>
            <option value="F">Loan Account</option>
            <option value="F">Savings Account</option>
        </select>
    </div>
...
<br>
    ...
    <div class="mb-10">
        ...
        <select class="form-select" name="apprv1" data-control="select2" data-placeholder="Select or type to search">
                <option></option>
                <option></option>
    ...
    <div class="mb-10">
        ...
        <input type="text" name="fundBudget" class="form-control"/>
    </div>
    ...
    <div class="row mb-10">
     <div class="col-md-6 fv-row fv-plugins-icon-container">
        ...
        <select name="fundtype" class="form-select" aria-label="Select example">
            <option selected="selected" value="">Select here</option>
            <option value="M">Private</option>
            <option value="F">Public</option>
            <option value="F">Government Parastatals</option>
        </select>
     </div>
     <div class="col-md-6 fv-row fv-plugins-icon-container">
    ...
    <div class="row mb-10">
     <div class="col-md-6 fv-row fv-plugins-icon-container">
        ...
        <select name="fundtype" class="form-select" aria-label="Select example">
            ...
            <option value="F">Brother</option>
            <option value="F">Sister</option>
            <option value="F">Child</option>

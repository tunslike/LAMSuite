...
?>
				...
				<div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
					...
					<h3 class="fw-bold my-2 welcomeTxt">Manage Customer CRM</h3>
               ...
               <?php foreach($data['customers'] as $customer): ?>
                ...
                <tr class="odd">
					...
					<span class="badge badge-light"><?php echo $customer->LAST_NAME.' '.$customer->FIRST_NAME; ?></span> 
                     ...
                     <td>
                     <div class="badge badge-light"><?php echo $customer->DATE_OF_BIRTH; ?></div>
                     </td>
                     <td>
					 ...
					 <?php 
                            switch($customer->KYC_STATUS) {
                                case 'Pending':
                                    echo '<div class="badge badge-light-danger">Pending</div>';
                                break;
                                case 'Completed':
                                    echo '<div class="badge badge-light-success">Completed</div>';
                                break;
                                case 'Partial':
                                    echo '<div class="badge badge-light-warning">Partial</div>';
                                break;
                            }
                     ...
                     <td>
                        <span class="badge badge-light"><?php echo $customer->EMPLOYER_NAME; ?></span>  
                     </td>
                     <td>

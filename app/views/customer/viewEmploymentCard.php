...
<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
    ...
    <div class="card-header cursor-pointer">
        ...
        <div class="card-title m-0">
            <h3 class="fw-bold m-0">Employment Record</h3>
        </div>
        <!--end::Card title--> 
    </div>
    <!--begin::Card header-->
	...
	<div class="row mb-10">
     <div class="col-md-6 fv-row fv-plugins-icon-container">
        ...
        <input type="text" name="employerArea" id="cust_loan_amount" value="<?php echo $data['employer']->COMPANY_NAME; ?>" readonly class="form-control"/>
     </div>
     <div class="col-md-6 fv-row fv-plugins-icon-container">
        <label for="exampleFormControlInput1" class="required form-label">Sector</label>
        <input type="text" value="<?php echo $data['employer']->SECTOR; ?>" readonly class="form-control"/>
     </div>
    </div>
	...
	<div class="row mb-10">
     <div class="col-md-6 fv-row fv-plugins-icon-container">
        ...
        <input type="text" value="<?php echo $data['employer']->GRADE_LEVEL; ?>" readonly class="form-control"/>
     </div>
     <div class="col-md-6 fv-row fv-plugins-icon-container">
        <label for="exampleFormControlInput1" class="required form-label">Service Length</label>
        <input type="text" value="<?php echo $data['employer']->SERVICE_LENGTH; ?>"  readonly class="form-control"/>
     </div>
    </div>

	<div class="row mb-10">
     <div class="col-md-6 fv-row fv-plugins-icon-container">
        <label for="exampleFormControlInput1" class="required form-label">Staff ID Number</label>
        <input type="text" readonly value="<?php echo $data['employer']->STAFF_ID_NUMBER; ?>" class="form-control"/>
     </div>
     <div class="col-md-6 fv-row fv-plugins-icon-container">
        <label for="exampleFormControlInput1" class="required form-label">Salary Payment Date</label>
        <input type="text" readonly value="<?php echo $data['employer']->SALARY_PAYMENT_DATE; ?>" class="form-control"/>
     </div>
    </div>

	<div class="row mb-10">
     <div class="col-md-6 fv-row fv-plugins-icon-container">
        <label for="exampleFormControlInput1" class="required form-label">Annual Salary</label>
        <input type="text" readonly value="<?php echo number_format($data['employer']->ANNUAL_SALARY); ?>" class="form-control"/>
     </div>
    </div>

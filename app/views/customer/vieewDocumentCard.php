...
<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
    ...
    <div class="card-header cursor-pointer">
        ...
        <div class="card-title m-0">
            <h3 class="fw-bold m-0">Next of Kin Record</h3>
        </div>
        <!--end::Card title--> 
    </div>
    <!--begin::Card header-->
	...
	<div class="row mb-10">
     <div class="col-md-6 fv-row fv-plugins-icon-container">
        <label for="exampleFormControlInput1" class="required form-label">NOK First Name</label>
        <input type="text" name="employerArea" value="<?php echo $data['nok']->NOK_FIRST_NAME; ?>" readonly class="form-control"/>
     </div>
     <div class="col-md-6 fv-row fv-plugins-icon-container">
        <label for="exampleFormControlInput1" class="required form-label">NOK Last Name</label>
        <input type="text" value="<?php echo $data['nok']->NOK_LAST_NAME; ?>" readonly class="form-control"/>
     </div>
    </div>

	<div class="row mb-10">
     <div class="col-md-6 fv-row fv-plugins-icon-container">
        <label for="exampleFormControlInput1" class="required form-label">NOK Gender</label>
        <input type="text" value="<?php echo $data['nok']->NOK_GENDER; ?>" readonly class="form-control"/>
     </div>
     <div class="col-md-6 fv-row fv-plugins-icon-container">
        <label for="exampleFormControlInput1" class="required form-label">NOK Relationship</label>
        <input type="text" value="<?php echo $data['nok']->NOK_RELATIONSHIP; ?>"  readonly class="form-control"/>
     </div>
    </div>

	<div class="row mb-10">
     <div class="col-md-6 fv-row fv-plugins-icon-container">
        <label for="exampleFormControlInput1" class="required form-label">NOK Phone Number</label>
        <input type="text" readonly value="<?php echo $data['nok']->NOK_PHONE; ?>" class="form-control"/>
     </div>
     <div class="col-md-6 fv-row fv-plugins-icon-container">
        <label for="exampleFormControlInput1" class="required form-label">NOK Email Address</label>
        <input type="text" readonly value="<?php echo $data['nok']->NOK_EMAIL_ADDRESS; ?>" class="form-control"/>
     </div>
    </div>
	...
	<div class="row mb-10">
     <div class="col-md-6 fv-row fv-plugins-icon-container">
        <label for="exampleFormControlInput1" class="required form-label">NOK Addressr</label>
        <input type="text" readonly value="<?php echo $data['nok']->NOK_ADDRESS; ?>" class="form-control"/>
     </div>
     <div class="col-md-6 fv-row fv-plugins-icon-container">
        <label for="exampleFormControlInput1" class="required form-label">NOK Locality</label>
        <input type="text" readonly value="<?php echo $data['nok']->NOK_AREA_LOCALITY; ?>" class="form-control"/>
     </div>
    </div>

	<div class="row mb-10">
     <div class="col-md-6 fv-row fv-plugins-icon-container">
        <label for="exampleFormControlInput1" class="required form-label">NOK State</label>
        <input type="text" readonly value="<?php echo $data['nok']->NOK_STATE; ?>" class="form-control"/>
     </div>
